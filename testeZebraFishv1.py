...
####### QUADRANTES #######
	...
	# l1h = cv2.line(frame, (1900,200), (0, 200), verde, 4)
	# l2h = cv2.line(frame, (1900, 540), (0, 540), verde, 4)
	# l3h = cv2.line(frame, (1900, 900), (0, 900), verde, 4)
...
#### FIM DOS QUADRANTES
	...
	horizontalLinePosition=120
	crossingLine[0][0]= 640
	crossingLine[0][1]= horizontalLinePosition
	crossingLine[1][0]= 770
...
# after nms and draw bounding box
		for i in indices:
			...
			#p1(x,y)  p2(x+w,y)  p3(x,y+h)  p4(x+w,y+h)
			p1 = ((2*x)+w)/2
			p2 = ((2*y)+h)/2

			centroide = cv2.circle(frame,(round(p1),round(p2)), 4, (0,0,255), -1)
			cv2.putText(frame,"Entradas: {}".format(str(round(centroide)),(10,50),cv2.FONT_HERSHEY_SIMPLEX,2,(0,0,255),1)
